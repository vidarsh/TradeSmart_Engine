...
impl Bot {
    ...
    pub fn run(
        ...
        loop {
            ...
            println!("fast ema ({}) = {}", fast_ema, fast_ema_value);
            println!("slow ema ({}) = {}", slow_ema, slow_ema_value);
